...
### Obacht: Auf dem Mac muss möglicherweise noch eine aktuelle Python-Version per homebrew installiert werden.

__Anleitung zur Installation von homebrew:__
https://docs.brew.sh/Homebrew-and-Python
__Anleitung zur Installation von Python:__
https://formulae.brew.sh/formula/python@3.14

__Danach:__

1. virtuelles Environment erzeugen: `python3 -m venv .venv`
2. Environment aktivieren `source .venv/bin/activate`
3. Abhängigkeiten installieren `pip install -r requirements.txt`

## Direkte Links auf Colab-Notebooks

### jwl 06/2026: sämtliche Notebooks lokal mit VS Code auf mac mini m4 / 32GB RAM getestet:
...
* Kapitel 9 (Moderne Sprachmodelle):
  * https://colab.research.google.com/github/djcordhose/buch-machine-learning-notebooks/blob/master/kap9-openai-api.ipynb
  * https://colab.research.google.com/github/djcordhose/buch-machine-learning-notebooks/blob/master/kap9-embeddings.ipynb
  * https://colab.research.google.com/github/djcordhose/buch-machine-learning-notebooks/blob/master/kap9-function-calling.ipynb
  * https://colab.research.google.com/github/djcordhose/buch-machine-learning-notebooks/blob/master/kap9-bert-tasks.ipynb
  * https://colab.research.google.com/github/djcordhose/buch-machine-learning-notebooks/blob/master/kap9-bert-fine-tuning.ipynb
* Kapitel 10 (MLOps - Machine Learning im Betrieb): 
  * https://colab.research.google.com/github/djcordhose/buch-machine-learning-notebooks/blob/master/kap10-train.ipynb
  * https://colab.research.google.com/github/djcordhose/buch-machine-learning-notebooks/blob/master/kap10-drift.ipynb
